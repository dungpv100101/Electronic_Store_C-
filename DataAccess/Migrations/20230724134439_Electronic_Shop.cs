...
{
    public partial class Electronic_Shop : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Account = table.Column<string>(type: "nchar(10)", fixedLength: true, maxLength: 10, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Useguide = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ProduceCountry = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StaffID = table.Column<int>(type: "int", nullable: false),
                    DeliverDate = table.Column<DateTime>(type: "date", nullable: true)
                },
                constraints: table =>
                {
